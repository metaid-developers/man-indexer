...
func (pb *Pebble) GetMrc20HistoryPageList(tickId string, page int64, size int64) (list []mrc20.Mrc20Utxo, total int64, err error) {
	return
}
...
func (pb *Pebble) GetMrc20BalanceByAddress(address string) (list []mrc20.Mrc20Balance, err error) {
	return
}
