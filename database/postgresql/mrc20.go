...
func (pg *Postgresql) UpdateMrc20TickInfo(tickId string, txPoint string, minted uint64) (err error) {
	return
}
...
func (pg *Postgresql) GetMrc20UtxoByOutPutList(outputList []string, isMempool bool) (list []*mrc20.Mrc20Utxo, err error) {
	return
}
